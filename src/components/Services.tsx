...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      pricing: (
        <>
          <div><span className="font-semibold text-brand-purple">Стоимость</span> консультации: 3 500₽ за час</div>
          <div><span className="font-semibold text-brand-purple">Стоимость</span> mock собеседования: 4 000₽ за ~1.5 часа</div>
        </>
      ),
